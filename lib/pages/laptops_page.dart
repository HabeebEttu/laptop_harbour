  ...
  Widget build(BuildContext context) {
    List<Laptop> laptopData = [
      Laptop(
        ...
        reviews: [
          Reviews(userId: 'user1', rating: 4.0, comment: 'Great laptop!', reviewDate: DateTime.now()),
          Reviews(userId: 'user2', rating: 5.0, comment: 'Amazing performance.', reviewDate: DateTime.now()),
        ],
        categoryId: '1',
        specs: Specs(processor: 'Intel Core i7', ram: '16GB', storage: '1TB SSD', display: '14" OLED'),
        tags: ['2-in-1', 'OLED'],
      ),
      Laptop(
        id: '2',
        ...
        reviews: [
          Reviews(userId: 'user3', rating: 4.5, comment: 'Good value for money.', reviewDate: DateTime.now()),
        ],
        categoryId: '1',
        specs: Specs(processor: 'Intel Core i5', ram: '8GB', storage: '512GB SSD', display: '15.6" FHD'),
      ...
      Laptop(
        ...
        reviews: [],
        categoryId: '1',
        specs: Specs(processor: 'Intel Core i7', ram: '16GB', storage: '512GB SSD', display: '13.4" FHD+'),
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [Icon(Icons.list, color: Colors.black87)],
                            ),
                          ),
                        ),
                      ],
